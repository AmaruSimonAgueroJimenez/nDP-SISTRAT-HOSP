...
## 1) Data loading (prefer in-memory; else RDS/Excel)
...
## 2) Time & event construction (no renaming; robust coding)
...
## 3) Recode levels to English (columns are preserved)
...
## 11) Nested models — **Cox PH** (M2 adds frequency)
...
## 12) Nested models — **Weibull AFT** (M2 adds frequency; TR)
...
## 13) Nested models — **Logistic regression** (M2 adds frequency; OR)
